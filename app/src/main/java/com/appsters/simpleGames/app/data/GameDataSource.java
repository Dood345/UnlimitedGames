package com.appsters.simpleGames.app.data;
...
public class GameDataSource {
        ...
        public static void clearAllGameData(android.content.Context context) {
                ...
                List<com.appsters.simpleGames.games.interfaces.IGame> games = new ArrayList<>();
                games.add(new com.appsters.simpleGames.games.game2048.Game2048Game(context));
                games.add(new com.appsters.simpleGames.games.sudoku.SudokuGame(context));
                games.add(new com.appsters.simpleGames.games.maze.MazeGame(context));
                games.add(new com.appsters.simpleGames.games.whackamole.WhackAMoleGame(context));
                games.add(new com.appsters.simpleGames.games.soccerseparationgame.SoccerSeparationGame(context));
                games.add(new com.appsters.simpleGames.games.poker.PokerGame(context));
