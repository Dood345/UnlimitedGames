...
public class LeaderboardRepository {
        ...
        OnCompleteListener<List<Score>> scoresListener = (isSuccess, scores, error) -> {
            ...
            friendRepository.getFriends(currentUserId, friendsTask -> {
                ...
                OnCompleteListener<Map<String, User>> filterStep = (uSuccess, userMap, uError) -> {
                    ...
                    for (Score s : scores) {
                        com.appsters.simpleGames.app.util.Privacy privacy = s.getPrivacy();
                        ...
                        if (privacy == null) {
                            privacy = com.appsters.simpleGames.app.util.Privacy.PUBLIC;
                        }

                        boolean isPublic = privacy == com.appsters.simpleGames.app.util.Privacy.PUBLIC;
                        boolean isFriendsOnly = privacy == com.appsters.simpleGames.app.util.Privacy.FRIENDS_ONLY;
    ...
    public void updateUserPrivacy(String userId, com.appsters.simpleGames.app.util.Privacy newPrivacy,
            ...
            if (task.isSuccessful() && task.getResult() != null) {
                ...
                for (Map.Entry<String, int[]> entry : userRankStats.entrySet()) {
                    ...
                    if (gamesPlayed > 0) {
                        ...
                        com.appsters.simpleGames.app.util.Privacy userPrivacy = com.appsters.simpleGames.app.util.Privacy.PUBLIC;
