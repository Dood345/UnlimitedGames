...
import com.appsters.simpleGames.databinding.ItemGameBinding;
            ...
            switch (game.getGameType()) {
                case SUDOKU:
                    color = androidx.core.content.ContextCompat.getColor(context,
                            com.appsters.simpleGames.R.color.teal_700);
                    break;
                case SOCCERSEPARATION:
                    color = androidx.core.content.ContextCompat.getColor(context,
                            com.appsters.simpleGames.R.color.green);
                    break;
                case WHACK_A_MOLE:
                    color = androidx.core.content.ContextCompat.getColor(context,
                            com.appsters.simpleGames.R.color.mole_red);
                    break;
                case MAZE:
                    color = androidx.core.content.ContextCompat.getColor(context,
                            com.appsters.simpleGames.R.color.purple_500);
                    break;
                case POKER:
                    color = androidx.core.content.ContextCompat.getColor(context,
                            com.appsters.simpleGames.R.color.poker_brown);
                    break;
                case GAME2048:
                default:
