package com.appsters.simpleGames.app.ui.profile;
...
import com.appsters.simpleGames.app.util.Privacy;
...
public class ProfileViewModel extends androidx.lifecycle.AndroidViewModel {
    ...
    private final com.appsters.simpleGames.app.data.repository.FriendRepository friendRepository;
    ...
    public ProfileViewModel(android.app.Application application) {
        ...
        friendRepository = new com.appsters.simpleGames.app.data.repository.FriendRepository();
