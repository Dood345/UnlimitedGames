...
import com.appsters.simpleGames.games.maze.controller.GameConfig
...
class UpgradeFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(com.appsters.simpleGames.R.layout.fragment_upgrade, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tvCurrency = view.findViewById(com.appsters.simpleGames.R.id.tv_available_currency)
        btnStamina = view.findViewById(com.appsters.simpleGames.R.id.btn_upgrade_stamina)
        btnSpeed = view.findViewById(com.appsters.simpleGames.R.id.btn_upgrade_speed)
        btnEfficiency = view.findViewById(com.appsters.simpleGames.R.id.btn_upgrade_efficiency)
        btnMainMenu = view.findViewById(com.appsters.simpleGames.R.id.btn_main_menu)
        btnNextLevel = view.findViewById(com.appsters.simpleGames.R.id.btn_next_level)
        
        tvSkillPoints = view.findViewById(com.appsters.simpleGames.R.id.tv_skill_points)
        btnUnlockWallSmash = view.findViewById(com.appsters.simpleGames.R.id.btn_unlock_wall_smash)
