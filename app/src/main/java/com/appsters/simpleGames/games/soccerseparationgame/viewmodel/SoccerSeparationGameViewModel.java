package com.appsters.simpleGames.games.soccerseparationgame.viewmodel;
        ...
        if (finalScore != null) {
            ...
            com.google.firebase.firestore.FirebaseFirestore.getInstance()
                    ...
                    .addOnSuccessListener(documentSnapshot -> {
                        com.appsters.simpleGames.app.data.model.User user = documentSnapshot
                                .toObject(com.appsters.simpleGames.app.data.model.User.class);
                        if (user != null) {
                            com.appsters.simpleGames.app.data.model.Score newScore = new com.appsters.simpleGames.app.data.model.Score(
                                    null,
                                    userId,
                                    user.getUsername(),
                                    com.appsters.simpleGames.app.util.GameType.SOCCERSEPARATION,
                                    finalScore,
                                    user.getPrivacy());

                            new com.appsters.simpleGames.app.data.repository.LeaderboardRepository(getApplication())
